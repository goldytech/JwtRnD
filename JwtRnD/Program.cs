...
//var token = await jwtUtils.GetAccessTokenFromDuendeIdentityServer();
var rsaKey = jwtUtils.GenerateRsaSecurityKey();
//var jsonWebKey = jwtUtils.CreateJWKFromRSA();
//Console.WriteLine(jsonWebKey);
var jsonWebKey = JsonWebKeyConverter.ConvertFromRSASecurityKey(rsaKey);
Console.WriteLine(jsonWebKey.HasPrivateKey);
var token2 = await JwtUtils2.RequestTokenAsync(new SigningCredentials(jsonWebKey, "RS256"));
